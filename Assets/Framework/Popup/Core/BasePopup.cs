...
namespace PopupSystem
{
	...
	public class BasePopup : MonoBehaviour
	{
		...
		public virtual void Awake()
		{
			...
			refStacks = PopupManager.Get.popupStacks;
		...
		public virtual void OnDisable()
		{
			...
			{
				PopupManager.Get.EvtTouchOverlay -= HandleCloseByOverlay;
			}
		}
		...
		void AnimateShow()
		{
			...
			{
				PopupManager.Get.ChangeTransparentOrder(mTransform, true, OnShowFinish);
			}

			PopupManager.Get.OnPopupOpen(this);
		}
